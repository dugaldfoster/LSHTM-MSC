####################################################################################################
#
# R code to reproduce data download, cleaning and analysis for India DHS data for my MSc project
...
### NB for large Indian datasets, loading data through rdhs may not work. See line 68. ###
...
#downloads <- get_datasets(datasets[grep("IA", datasets$FileName), ])
#
##Read in data for IR files
#iair92 <- readRDS(downloads$IAIR23FL)
#iair98 <- readRDS(downloads$IAIR42FL)
#iair06 <- readRDS(downloads$IAIR52FL)
#iair16 <- readRDS(downloads$IAIR74FL)

#Alternatively,download datasets individually
#downloads <- get_datasets("IAIR23FL.ZIP")

#NB "No access" to ("IAIR74FL.ZIP")
#And ZIP function not working on: ("IAIR42FL.ZIP") and ("IAIR52FL.ZIP")

## If "Zip" function not working, download file directly from DHS
#Put file in wd, then read in the dataset from wd
library(foreign)
iair06 <- read.dta("IAIR52FL.dta")
iair16 <- read.dta("IAIR74FL.dta")

##### 2. Data cleaning and manipulation #####
#NB datasets are very large, so extract vars before merging

#Select variables to extract from datasets
...
iair16 <- iair16[myvars]
iair06 <- iair06[myvars]

#Save large dataframes in workspace to reload for future use
save.image() 

#Set PSUs for iair06 to match cluster number
iair06$v021 <- iair06$v001

### Merge all datasets together ###

#rbind.fill will add columns that are not present in all datasets
library(plyr)
dhsdata <- rbind.fill(iair06, iair16)

#Set variable values as numeric
#v025 (rural/urban)
dhsdata$v025 <- as.numeric(dhsdata$v025)

#b0_ (twinning status)
dhsdata$b0_01 <- as.numeric(dhsdata$b0_01)
dhsdata$b0_02 <- as.numeric(dhsdata$b0_02)
dhsdata$b0_03 <- as.numeric(dhsdata$b0_03)
dhsdata$b0_04 <- as.numeric(dhsdata$b0_04)
dhsdata$b0_05 <- as.numeric(dhsdata$b0_05)
dhsdata$b0_06 <- as.numeric(dhsdata$b0_06)
dhsdata$b0_07 <- as.numeric(dhsdata$b0_07)
dhsdata$b0_08 <- as.numeric(dhsdata$b0_08)
dhsdata$b0_09 <- as.numeric(dhsdata$b0_09)
dhsdata$b0_10 <- as.numeric(dhsdata$b0_10)
dhsdata$b0_11 <- as.numeric(dhsdata$b0_11)
dhsdata$b0_12 <- as.numeric(dhsdata$b0_12)
dhsdata$b0_13 <- as.numeric(dhsdata$b0_13)
dhsdata$b0_14 <- as.numeric(dhsdata$b0_14)
dhsdata$b0_15 <- as.numeric(dhsdata$b0_15)
dhsdata$b0_16 <- as.numeric(dhsdata$b0_16)
dhsdata$b0_17 <- as.numeric(dhsdata$b0_17)
dhsdata$b0_18 <- as.numeric(dhsdata$b0_18)
dhsdata$b0_19 <- as.numeric(dhsdata$b0_19)
dhsdata$b0_20 <- as.numeric(dhsdata$b0_20)

#b4_ (child sex)
dhsdata$b4_01 <- as.numeric(dhsdata$b4_01)
dhsdata$b4_02 <- as.numeric(dhsdata$b4_02)
dhsdata$b4_03 <- as.numeric(dhsdata$b4_03)
dhsdata$b4_04 <- as.numeric(dhsdata$b4_04)
dhsdata$b4_05 <- as.numeric(dhsdata$b4_05)
dhsdata$b4_06 <- as.numeric(dhsdata$b4_06)
dhsdata$b4_07 <- as.numeric(dhsdata$b4_07)
dhsdata$b4_08 <- as.numeric(dhsdata$b4_08)
dhsdata$b4_09 <- as.numeric(dhsdata$b4_09)
dhsdata$b4_10 <- as.numeric(dhsdata$b4_10)
dhsdata$b4_11 <- as.numeric(dhsdata$b4_11)
dhsdata$b4_12 <- as.numeric(dhsdata$b4_12)
dhsdata$b4_13 <- as.numeric(dhsdata$b4_13)
dhsdata$b4_14 <- as.numeric(dhsdata$b4_14)
dhsdata$b4_15 <- as.numeric(dhsdata$b4_15)
dhsdata$b4_16 <- as.numeric(dhsdata$b4_16)
dhsdata$b4_17 <- as.numeric(dhsdata$b4_17)
dhsdata$b4_18 <- as.numeric(dhsdata$b4_18)
dhsdata$b4_19 <- as.numeric(dhsdata$b4_19)
dhsdata$b4_20 <- as.numeric(dhsdata$b4_20)

#b5_ (child alive)
dhsdata$b5_01 <- as.numeric(dhsdata$b5_01)
dhsdata$b5_02 <- as.numeric(dhsdata$b5_02)
dhsdata$b5_03 <- as.numeric(dhsdata$b5_03)
dhsdata$b5_04 <- as.numeric(dhsdata$b5_04)
dhsdata$b5_05 <- as.numeric(dhsdata$b5_05)
dhsdata$b5_06 <- as.numeric(dhsdata$b5_06)
dhsdata$b5_07 <- as.numeric(dhsdata$b5_07)
dhsdata$b5_08 <- as.numeric(dhsdata$b5_08)
dhsdata$b5_09 <- as.numeric(dhsdata$b5_09)
dhsdata$b5_10 <- as.numeric(dhsdata$b5_10)
dhsdata$b5_11 <- as.numeric(dhsdata$b5_11)
dhsdata$b5_12 <- as.numeric(dhsdata$b5_12)
dhsdata$b5_13 <- as.numeric(dhsdata$b5_13)
dhsdata$b5_14 <- as.numeric(dhsdata$b5_14)
dhsdata$b5_15 <- as.numeric(dhsdata$b5_15)
dhsdata$b5_16 <- as.numeric(dhsdata$b5_16)
dhsdata$b5_17 <- as.numeric(dhsdata$b5_17)
dhsdata$b5_18 <- as.numeric(dhsdata$b5_18)
dhsdata$b5_19 <- as.numeric(dhsdata$b5_19)
dhsdata$b5_20 <- as.numeric(dhsdata$b5_20)

#Recode b5 to match DHS codes
library(car)
dhsdata[104:123] <- recode(dhsdata[104:123],"1=0;2=1")
...
#Reorder vars so tcd comes after son and daughter deaths
names(dhsdata)
dhsdata <- dhsdata[,c(1:22,187,23:186)]

#Create new variable for maternal age at birth x = year of birth x - mother's year of birth
...
#Max CEB is 17, therefore keep all birth order columns (ignore _18-20 columns)
...
#Save data
save.image("~/Desktop/Rwd/R Workspaces/IADataLongmums.RData")
...
#Check v021 matches v001
longmums$v021 <- longmums$v001
longmumsdaughts$v021 <- longmumsdaughts$v001
